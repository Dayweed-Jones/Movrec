...
from ..models import CBSimilarity
...
class ContentBasedRecommender:
    ...
    def get_similar_movies(self, movie_id, top_n=10):
        ...
        """
        similar_movies = CBSimilarity.objects.filter(movie_1_id=movie_id, similarity__gte=self.min_sim) \
    ...
    def seeded_rec(self, content_ids, take=6):
        ...
        """
        data = CBSimilarity.objects.filter(movie_1__in=content_ids) \
                                    .order_by('-similarity') \
    ...
    def recommend_items(self, user_id, num=6):
        ...
        sims = CBSimilarity.objects.filter(Q(movie_1__in=movie_ids.keys())
