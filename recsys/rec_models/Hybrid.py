...
class FeatureWeightedLinearStacking():
    def __init__(self):
        ...
        self.wcb1 = Decimal(0.168)
        self.wcb2 = Decimal(0)
        self.wcf1 = Decimal(0.114)
        self.wcf2 = Decimal(0)
    ...
    @staticmethod
    def fun2(user_id):
        count = MLRatings.objects.filter(user=user_id).count()
        return count ** Decimal(0.5)
    ...
    def set_save_path(self, save_path):
        with open(save_path + 'fwls_parameters.data', 'rb') as ub_file:
            ...
            self.wcf1 = Decimal(parameters['cf1'])
